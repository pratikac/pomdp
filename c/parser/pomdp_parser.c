...
#line 396 "pomdp_parser.y"
    {
		   ...
		   XFREE( (yyvsp[(3) - (3)].constBlk)->theValue.theString );
		   XFREE( (yyvsp[(3) - (3)].constBlk) );
                }
    break;
...
#line 610 "pomdp_parser.y"
    {
				 ...
				 (yyval.i_num) = num;
                   ...
                   XFREE( (yyvsp[(1) - (1)].constBlk)->theValue.theString );
                   XFREE( (yyvsp[(1) - (1)].constBlk) );
                }
    break;
